...
public class ClientListener implements ClientInListener {
    ...
    public void onHostGame(HostGame packet) {
        ...
        manager.sendReliablePacket(new HostGame(lobby));
    }
    ...
    public void onJoinGame(JoinGame packet) {
        ...
        manager.sendReliablePacket(new JoinedGame(client, lobby));
    }
...
//            }
        ...
        switch (parts[0]) {
            case "sethat": {
                ...
                try {
                    ...
                    manager.sendReliablePacket(new GameData(gameId, new RPC(netId, new SetHat(id))));
                } catch (Exception e) {}
                break;
            }
            ...
            case "setpet": {
                ...
                try {
                    int id = Integer.valueOf(parts[1]);
                    manager.sendReliablePacket(new GameData(gameId, new RPC(netId, new SetPet(id))));
                } catch (Exception e) {}
                break;
            }
            ...
            case "setcolor": {
                ...
                try {
                    int id = Integer.valueOf(parts[1]);
                    manager.sendReliablePacket(new GameData(gameId, new RPC(netId, new CheckColor(id))));
                } catch (Exception e) {}
                break;
            }
            ...
            case "setname": {
                ...
                manager.sendReliablePacket(new GameData(gameId, new RPC(netId, new CheckName(cmd.substring(8).trim()))));
                break;
            }
            ...
            case "chat": {
                ...
                manager.sendReliablePacket(new GameData(gameId, new RPC(control.getNetId(), SendChat.of(parts[1]))));
                break;
            }
        ...
        if (cmd.startsWith("/name ")) {
            ...
            if (!name.isEmpty()) {
                for (Player p : lobby.getPlayers()) {
                    ...
                    manager.sendReliablePacket(new GameData(gameId, new RPC(control.getNetId(), new CheckName(name))));
                }
            }
        }
    }
    ...
    public void setupTest(Player custom) {
        ...
        manager.sendReliablePacket(new JoinGame(lobby, custom));
